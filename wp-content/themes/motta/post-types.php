...
// Register Custom Post Type
function merchandise_post_type()
{
    $labels = array(
...
add_action('init', 'merchandise_post_type', 0);

/**
 * Remove meta box fields
 */
function remove_merchandise_fields()
{
...
add_action('admin_menu', 'remove_merchandise_fields');

function remove_merchandise_side_fields()
{
    remove_meta_box('postimagediv', 'merchandise', 'side');
    remove_meta_box('tagsdiv-post_tag', 'merchandise', 'side');
}
add_action('do_meta_boxes', 'remove_merchandise_side_fields');
